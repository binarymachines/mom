package com.angrysurfer.mildred;
...
public class MildredTestContainer extends TestContainer {

    public MildredTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/angrysurfer/mildred/app.properties",
    ...
    public static class Common extends MildredTestContainer {

        public static final MildredTestContainer.Common INSTANCE = new MildredTestContainer.Common();
