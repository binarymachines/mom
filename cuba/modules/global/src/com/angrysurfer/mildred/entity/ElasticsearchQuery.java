...
public class ElasticsearchQuery extends BaseIntIdentityIdEntity {
    private static final long serialVersionUID = 8018929949387244174L;
    ...
    @ManyToMany
    protected List<ElasticsearchQueryField> docQueryField;

    public ElasticsearchQueryType getQueryType() {
        return queryType == null ? null : ElasticsearchQueryType.fromId(queryType);
    }

    public void setQueryType(ElasticsearchQueryType queryType) {
    ...
    public void setDocQueryField(List<ElasticsearchQueryField> docQueryField) {
        this.docQueryField = docQueryField;
    }

    public List<ElasticsearchQueryField> getDocQueryField() {
