...
sqlacodegen mysql://$1:$2@localhost/media > $MILDRED_HOME/python/server/db/generated/sqla_media.py
# sqlacodegen mysql://$1:$2@localhost/analysis --tables action_dispatch,action,action_param,meta_action,meta_action_param,reason,reason_param,meta_reason,meta_reason_param,action_reason,m_action_m_reason > $MILDRED_HOME/python/server/db/generated/sqla_action.py
