...
INSERT INTO `directory_constant` (`id`, `pattern`, `directory_type`) VALUES (1,'/compilations','compilation'),(2,'compilations/','compilation'),(3,'/various','compilation'),(4,'/bak/','ignore'),(5,'/webcasts and custom mixes','extended'),(6,'/downloading','incomplete'),(7,'/live','live_recording'),(8,'/slsk/','new'),(9,'/incoming/','new'),(10,'/random','random'),(11,'/recently','recent'),(12,'/unsorted','unsorted'),(13,'[...]','side_project'),(14,'albums','album'),(15,'noscan','no_scan');
...
-- Dump completed on 2018-04-21  1:27:43
