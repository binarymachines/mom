...
INSERT INTO `mode_state_default` (`id`, `mode_id`, `state_id`, `priority`, `effect_dispatch_id`, `times_to_complete`, `dec_priority_amount`, `inc_priority_amount`, `error_tolerance`) VALUES (1,3,2,5,17,1,1,0,0);
INSERT INTO `mode_state_default` (`id`, `mode_id`, `state_id`, `priority`, `effect_dispatch_id`, `times_to_complete`, `dec_priority_amount`, `inc_priority_amount`, `error_tolerance`) VALUES (2,3,3,5,18,1,1,0,0);
INSERT INTO `mode_state_default` (`id`, `mode_id`, `state_id`, `priority`, `effect_dispatch_id`, `times_to_complete`, `dec_priority_amount`, `inc_priority_amount`, `error_tolerance`) VALUES (3,3,4,5,19,1,1,0,0);
