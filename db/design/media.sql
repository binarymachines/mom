...
INSERT INTO `media`.`directory_type` (`name`) VALUES ("default");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("owner");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("user");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("location");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("format");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("collection");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("category");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("genre");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("artist");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("album");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("compilation");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("single");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("producer");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("label");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("actor");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("directory");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("movie");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("series");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("show");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("author");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("book");
INSERT INTO `media`.`directory_type` (`name`) VALUES ("speaker");
...
-- CREATE TABLE IF NOT EXISTS `media`.`path_hierarchy` (
--   `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--     REFERENCES `media`.`path_hierarchy` (`id`)
-- );
