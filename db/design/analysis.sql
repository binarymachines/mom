...
CREATE TABLE IF NOT EXISTS `analysis`.`meta_action` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `analysis`.`meta_action_param` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_meta_action_param_meta_action`
    ...
    REFERENCES `analysis`.`meta_action` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
);

CREATE TABLE IF NOT EXISTS `analysis`.`meta_reason` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NOT NULL,
  ...
  CONSTRAINT `meta_reason_ibfk_1`
    ...
    REFERENCES `analysis`.`meta_reason` (`id`),
...
CREATE TABLE IF NOT EXISTS `analysis`.`m_action_m_reason` (
  `meta_action_id` INT(11) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `analysis`.`meta_reason_param` (
    `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
