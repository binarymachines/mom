...
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Audio'), 'ape', 'ape');
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Audio'), 'mp3', 'mp3');
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Audio'), 'flac', 'FLAC');
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Audio'), 'ogg', 'Ogg-Vorbis');
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Audio'), 'wave', 'Wave');
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Audio'), 'mpc', 'mpc');
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Graphic'), 'jpg', 'jpeg');
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Graphic'), 'jpeg', 'jpeg');
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Graphic'), 'png', 'png');
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Video'), 'mp4', 'mp4');
INSERT INTO media_format (`media_type_id`, `ext`, `name`) VALUES ((select id from media_type where name like 'Video'), 'flv', 'flv');
...
CREATE TABLE `elastic` (
  ...
  `media_format_id` int(11) unsigned NOT NULL,
...
CREATE TABLE `media` (
  ...
  CONSTRAINT `fk_media_media_format_type` FOREIGN KEY (`media_format_id`) REFERENCES `media_format` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
