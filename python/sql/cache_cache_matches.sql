...
--
SELECT m.doc_id id, m.match_doc_id match_id, matcher_name FROM match_record m, document esd
 WHERE esd.id = m.doc_id AND esd.absolute_path like "%s*"
 UNION
SELECT m.match_doc_id id, m.doc_id match_id, matcher_name FROM match_record m, document esd
