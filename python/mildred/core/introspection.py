...
# persistence of mode state allow modes to be restored and replayed, allowing analysis of transitions between mode state snapshots, which describes traverals
